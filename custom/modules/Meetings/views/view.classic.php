...
class MeetingsViewClassic extends ViewClassic{
    ...
    $(function() {
                ...
                $('#btn_parent_name').unbind('click').removeAttr('onclick').click(function(e) {
                      e.preventDefault();
                      open_popup($('#parent_type').val(), 600, 400, '', true, false, {'call_back_function':'custom_set_return','form_name':'form_SubpanelQuickCreate_Meetings','field_to_name_array':{'id':'parent_id','name':'parent_name'}}, 'single', true);
